...
if [ -f ".forge/scripts/test_fast.sh" ]; then
  cp .forge/scripts/test_fast.sh /tmp/_forge_test_fast_backup.sh
fi
...
if [ -f "/tmp/_forge_test_fast_backup.sh" ]; then
  cp /tmp/_forge_test_fast_backup.sh .forge/scripts/test_fast.sh
  rm /tmp/_forge_test_fast_backup.sh
fi
